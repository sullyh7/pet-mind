    ...
    return (
        <div className='w-full flex items-center justify-between'>
            ...
            <div className='flex gap-x-3 items-center'>
                ...
                {user && <Link href={user.user_metadata.type == "ownder" ?  "/dashboard/owner" : "/dashboard/minder"} className={cn(" text-background bg-[#DB3066]", buttonVariants({ variant: "ghost" }))}>Dashboard</Link>}
